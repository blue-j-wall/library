...
const GET_POST_SQL = 'SELECT * FROM Fic WHERE id<21;'
/*
...
await db.exec("CREATE TABLE IF NOT EXISTS Fic(id INTEGER PRIMARY KEY UNIQUE, title TEXT NOT NULL, author TEXT NOT NULL, fandoms TEXT NOT NULL, wordcount INTEGER NOT NULL, comments TEXT, link TEXT NOT NULL);")
