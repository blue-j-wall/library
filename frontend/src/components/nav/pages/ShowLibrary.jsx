...
export default function ShowLibrary(props) {
   ...
   const resetActiveEntry = () => {
    ...
    return <>
        ...
        <AddModal show={showAddModal} hide={handleHideAddModal} confirm={handleAdd} type="Shows"/>

        <EditModal show={showEditModal} hide={handleHideEditModal} confirm={handleEdit} type="Shows"/>
